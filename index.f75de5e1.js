...
wall.addEventListener("click", (e)=>{
    ...
    const [spiderWidth, spiderHeight] = [
        spiderRect.width,
        spiderRect.height
    ];
    ...
    leftX = Math.min(Math.max(leftX, spiderWidth / 2), wall.clientWidth - spiderWidth / 2);
    topY = Math.min(Math.max(topY, spiderHeight / 2), wall.clientHeight - spiderHeight / 2);
